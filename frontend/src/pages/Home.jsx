...
function Home() {
  ...
  // Images from /public folder (works in both dev and production)
  const slides = [
    { img: '/ad_jobcon.png', title: 'Find Verified Jobs', text: 'Your dream job is just a click away' },
    { img: '/secure.png', title: '100% Secure', text: 'Your payments are protected with escrow' },
    { img: '/trust.png', title: 'Trusted Agents', text: 'Every agent is verified with NIN & BVN' },
    { img: '/transparent.png', title: 'Transparent Process', text: 'No hidden fees, full transparency' },
  ];
    ...
    <div className="home">
      ...
      <section className="section how-it-works">
        ...
        <div className="steps-wrapper">
          <div className="steps-image-container">
            <img src="/step_to_take.png" alt="Steps to take" className="steps-main-image" />
          </div>
          <div className="steps">
      ...
      <section className="section features">
        ...
        <div className="feature-grid">
          <div className="feature-card"><img src="/secure.png" alt="Verified Jobs" className="feature-card-img" /><h3>100% Verified Jobs</h3><p>Every job posting is verified by our team before it goes live. No fake jobs, no scams.</p></div>
          <div className="feature-card"><img src="/high_security.png" alt="Secure Escrow" className="feature-card-img" /><h3>Secure Escrow</h3><p>Your commission is held safely until you confirm you've gotten the job.</p></div>
          <div className="feature-card"><img src="/trust.png" alt="Trusted Agents" className="feature-card-img" /><h3>Trusted Agents</h3><p>Agents verified with NIN, BVN, face recognition, fingerprint, and guarantor details.</p></div>
          <div className="feature-card"><img src="/commission.png" alt="Quality Jobs" className="feature-card-img" /><h3>Quality Jobs</h3><p>Only genuine, well-paying positions from verified organizations across Nigeria.</p></div>
          <div className="feature-card"><img src="/transparent.png" alt="Transparent Fees" className="feature-card-img" /><h3>Transparent Fees</h3><p>5-35% commission. 83% to agent, 17% platform fee. No hidden charges.</p></div>
          <div className="feature-card"><img src="/veri_process.png" alt="Fast Process" className="feature-card-img" /><h3>Fast Process</h3><p>Apply, sign, and pay in minutes. Start your new job journey today!</p></div>
        </div>
      </section>
      ...
      <section className="section customer-care">
        <div className="customer-care-grid">
          <div className="customer-care-image">
            <img src="/good_customercare.png" alt="Customer Care" />
          </div>
